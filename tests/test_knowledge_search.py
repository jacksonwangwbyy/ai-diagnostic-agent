...
class TestSearchKnowledgeBase:
    ...
    def test_no_results(self):
        """检索无结果"""
        with patch("src.tools.knowledge_search.enhanced_search", return_value=[]):
    ...
    def test_results_with_headers(self):
        ...
        with patch("src.tools.knowledge_search.enhanced_search", return_value=[(doc, 0.85)]):
    ...
    def test_results_without_headers(self):
        ...
        with patch("src.tools.knowledge_search.enhanced_search", return_value=[(doc, 0.7)]):
    ...
    def test_multiple_results(self):
        ...
        with patch("src.tools.knowledge_search.enhanced_search", return_value=docs):
    ...
    def test_content_truncation(self):
        ...
        with patch("src.tools.knowledge_search.enhanced_search", return_value=[(doc, 0.5)]):
